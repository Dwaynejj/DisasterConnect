...
class LoginWidget(QWidget):
    ...
    def _verify_password(self, stored_hash: str, password: str) -> bool:
        ...
        The stored hash format is: 'salt:sha256(password+salt)'
        This must match the format used in auth_manager.py.
        """
        try:
    ...
    def handle_login(self):
        ...
        try:
            ...
            if user and self._verify_password(user.get("password", ""), password):
